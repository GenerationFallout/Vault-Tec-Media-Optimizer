...
return [
	'VaultTecMediaOptimizer.Config' => static function (
	...
	'VaultTecMediaOptimizer.OptimizerFactory' => static function (
		MediaWikiServices $services
	): OptimizerFactory {
	...
	'VaultTecMediaOptimizer.WebPRepo' => static function (
		MediaWikiServices $services
	): WebPRepo {
		return new WebPRepo(
			$services->getService( 'VaultTecMediaOptimizer.Config' ),
	...
	'VaultTecMediaOptimizer.ZopfliRecompressor' => static function (
		MediaWikiServices $services
	): PngRecompressorInterface {
	...
	'VaultTecMediaOptimizer.PngRecompressor.zopfli' => static function (
		MediaWikiServices $services
	): ZopfliRecompressor {
	...
	'VaultTecMediaOptimizer.PngRecompressor.oxipng' => static function (
		MediaWikiServices $services
	): OxipngRecompressor {
	...
	'VaultTecMediaOptimizer.ZopfliOriginalProcessor' => static function (
		MediaWikiServices $services
	): ZopfliOriginalProcessor {
	...
	'VaultTecMediaOptimizer.OptimizationRecord' => static function (
		MediaWikiServices $services
	): OptimizationRecord {
	...
	'VaultTecMediaOptimizer.GifOptimizer' => static function (
		MediaWikiServices $services
	): GifOptimizer {
	...
	'VaultTecMediaOptimizer.ImageProcessor' => static function (
		MediaWikiServices $services
	): ImageProcessor {
	...
	'VaultTecMediaOptimizer.HtmlRewriter' => static function (
		MediaWikiServices $services
	): HtmlRewriter {
	...
	'VaultTecMediaOptimizer.BackfillScheduler' => static function (
		MediaWikiServices $services
	): BackfillScheduler {
	...
	'VaultTecMediaOptimizer.PrerequisiteChecker' => static function (
		MediaWikiServices $services
	): PrerequisiteChecker {
